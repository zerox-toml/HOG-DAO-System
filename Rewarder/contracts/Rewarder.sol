...
contract Rewarder is ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        require(_maximumStake > _minimumStake, "Maximum stake must be greater than minimum");

        rewardsToken = IERC20(_rewardsToken);
        stakingToken = IERC20(_stakingToken);
        minimumStakeAmount = _minimumStake;
        maximumStakeAmount = _maximumStake;
    }
    ...
    function stake(uint256 amount) external nonReentrant updateReward(msg.sender) {
        ...
        require(_balances[msg.sender].add(amount) <= maximumStakeAmount, "Exceeds maximum stake amount");
    ...
    function setStakeLimits(uint256 _minimum, uint256 _maximum) external onlyOwner {
        require(_minimum > 0, "Minimum stake must be greater than 0");
        require(_maximum > _minimum, "Maximum stake must be greater than minimum");
        minimumStakeAmount = _minimum;
        maximumStakeAmount = _maximum;
